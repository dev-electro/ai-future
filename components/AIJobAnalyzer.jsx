...
// Constants (LB_DATA, QUICK_PICKS, THEMES, LEVELS, BLS_C, URGENCY, ls*) → lib/analyzerConstants.js
...
function AnalyzePage({ th, t, initialJob, onToast, lang }) {
  ...
  // ── Local model (WebGPU worker) via extracted hook ────────────────────────
  const {
    localProgress, setLocalProgress,
    isLocalReady, setIsLocalReady,
    localModeLoading, setLocalModeLoading,
    localModelVersion, setLocalModelVersion,
    webGPUSupported, cachedModels, setCachedModels, recommendedMode,
