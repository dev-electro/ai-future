/**
 * lib/llm.js — Multi-provider LLM failover
 *
 * Strategy: Give Gemini 31B the full Edge budget (28s).
 * It produces the richest analysis — worth waiting for.
 * OpenRouter is emergency-only if Gemini hard-fails or times out.
 *
 * Vercel Edge hard limit: 30s. We stay 2s under to allow response serialization.
 */

const TIMEOUT_GEMINI_MS    = 25_000; // Safe budget for Edge limit
const TIMEOUT_FALLBACK_MS  =  8_000; // OpenRouter: quick fail
...
const PROVIDERS = [
    {
        ...
        timeoutMs: TIMEOUT_FALLBACK_MS, // Fast timeout for free tier
    },
    {
        id:        "Gemini:gemma-4-26b-a4b-it",
        url:       "https://generativelanguage.googleapis.com/v1beta/openai/chat/completions",
        model:     "gemma-4-26b-a4b-it",      // Fallback: MoE with thinking tokens
