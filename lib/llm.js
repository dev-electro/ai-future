...
const TIMEOUT_GEMINI_MS    = 28_000; // Gemini 31B: full budget
const TIMEOUT_FALLBACK_MS  =  8_000; // OpenRouter: emergency only
...
const PROVIDERS = [
    {
        ...
        model:     "gemma-4-26b-a4b-it",      // Primary: MoE with thinking tokens
